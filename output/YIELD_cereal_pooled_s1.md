...
| satellite features | 253 | **0.465** | +1.254 | 1.202 | 0.948 | 0.706 | 0.702 |
| satellite + year/state | 253 | **0.511** | +1.300 | 1.149 | 0.882 | 0.735 | 0.722 |
...
| satellite features | 1089 | **0.568** | +0.248 | 1.157 | 0.903 | 0.754 | 0.759 |
| satellite + year/state | 1089 | **0.591** | +0.271 | 1.125 | 0.860 | 0.769 | 0.774 |
