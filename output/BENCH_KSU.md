...
- Pending when this was written: a 10-tile verification of the per-composite prompt grid (job 178481584); the 100-tile arm above used one grid for the whole job.
